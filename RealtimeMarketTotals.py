...
year=2015
file_folder='/home/peak/Dropbox (Peak Power Inc)/IESO/IESO_Organized/%s/Realtime Market totals Report/'%year
csv_folder='/home/peak/IESO-CSV/%s/Realtime Market totals Report/'%year
day_folder= '/home/peak/IESO-DAY/%s/Realtime Market totals Report/'%year
...
def year_xml2df_RealtimeMarketTotals(xml_folder):
    gen_file_list=generate_list_RealtimeMarketTotals('%s-01-01 00:00'%year,'%s-12-31 23:00'%year,xml_folder)
...
year_xml2df_RealtimeMarketTotals(file_folder)
csv_hour_data()
